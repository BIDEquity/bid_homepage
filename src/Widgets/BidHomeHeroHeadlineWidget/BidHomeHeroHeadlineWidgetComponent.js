...
Scrivito.provideComponent("BidHomeHeroHeadlineWidget", ({ widget }) => {
  return (
    <div className="top_inner">
      <Scrivito.ContentTag
        ...
        content={widget}
        attribute="headline"
        className="home_top_title bottom_line aos-init aos-animate"
      />
      <a className="scroll_anchor top_scroll" href="#mainContent">
